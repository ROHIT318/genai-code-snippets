...
This script demonstrates a LangGraph workflow that classifies user input to determine whether to perform an Excel-style data transformation (using pandas) or a simple conversational Q&A.
  Methods: 
